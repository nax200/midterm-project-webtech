...
@section('content')
    <section class="mx-8">
        ...
        <div class="my-1 px-8 py-2 flex flex-wrap dy-6">
            @foreach($tag->posts as $post)
                <a href="{{ route('posts.show', ['post' => $post]) }}"
                   class="block min-h-full w-full mx-4 my-3 p-6 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
