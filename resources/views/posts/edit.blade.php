...
.slider.round:before {
  border-radius: 50%;
    ...
    <input type="checkbox" name="incognito" id="incognito" value="1" {{($post->incognito) == "1" ? 'checked' :''}} @can('updateStatus', $post) disabled @endcan>>
    ...
    <button class="block app-button red ml-4 my-2" onclick="showDelete()" class="app-button red">DELETE</button>
